...
SECRET_KEY = '@m5m$++s%tge(wg@y##+-xwfwidz_%fg)^kff+m(6fdchbukt1'
...
if DEBUG:
    # used for development only, won't actually send email
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onbiehha',
        'USER': 'onbiehha',
        'PASSWORD': '5FFQe2UO2rcWimDPuX83YP2j4mb3mLwU',
